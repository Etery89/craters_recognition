...
image = cv2.imread("APOLLO17_DTM_150CM_180_45.tif", 0)
...
radius = 100
while radius < 200: 
    circles = cv2.HoughCircles(image, cv2.HOUGH_GRADIENT, 1 , 10, param1=30,param2=20,minRadius=(radius),maxRadius=(radius+10))
    radius += 10
    if circles is None:
        continue
